...
// Source: github.com/KongZ/kubeai-chatbot/pkg/api (interfaces: ChatMessageStore)
//
// Generated by this command:
//
//	mockgen -destination=agent_mock.go -package=mocks github.com/KongZ/kubeai-chatbot/pkg/api ChatMessageStore
//
